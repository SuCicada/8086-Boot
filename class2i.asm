...
clock_show_info: 
    ...
    mov bx,di   ; backup 
    clock_show_info_s:
        mov al,cs:[offset clock_info][bp][si]
        cmp al,1
        jne clock_show_info_currentline
            mov di,bx
            add di,160
            mov bx,di
            jmp clock_show_info_so
        clock_show_info_currentline:
        mov es:[di],al
        mov byte ptr es:[di+1],7
        add di,2
        clock_show_info_so:
        add si,1
    loop clock_show_info_s
    pop bp
    pop si
    pop di
    pop es
